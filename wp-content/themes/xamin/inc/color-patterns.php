 ...
 */
function xamin_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter xamin default saturation level.
	 *
	 * @since xamin 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'xamin_custom_colors_saturation', 50 ) );
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters xamin custom colors CSS.
	 *
	 * @since xamin 1.0
	 *
	 ...
	 */
	return apply_filters( 'xamin_custom_colors_css', $css, $hue, $saturation );
}
?>