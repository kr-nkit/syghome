...
class Map {
	...
	public function render( $atts, $core ) {
		...
		$before = apply_filters( 'igm_mapbox_before', '' );
		$after  = apply_filters( 'igm_mapbox_after', '' );
		...
		$max_width = isset( $this->meta['visual']['maxWidth'] ) && '' !== $this->meta['visual']['maxWidth'] ? $this->meta['visual']['maxWidth'] : '1200';
